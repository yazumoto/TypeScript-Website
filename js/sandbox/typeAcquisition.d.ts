 ...
 */
export declare const detectNewImportsToAcquireTypeFor: (sourceCode: string, userAddLibraryToRuntime: AddLibToRuntimeFunc, fetcher: typeof fetch | undefined, playgroundConfig: SandboxConfig) => Promise<void>;
